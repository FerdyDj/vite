...
export default function Counter() {
  ...
  return (
    <div className="flex flex-col w-screen h-screen justify-center items-center">
      <h1 className="text-6xl font-bold">Counter with Undo/Redo</h1>
      ...
      <div className="flex mt-5 gap-4">
        <button
          onClick={decrement}
          className="flex justify-center bg-gray-200 w-10 rounded-md cursor-pointer"
        >
          -
        </button>
        <button
      ...
      <div className="flex mt-5 gap-4">
        <button
          onClick={undo}
          disabled={position === 0}
          className="flex justify-center bg-teal-200 w-15 rounded-md cursor-pointer disabled:bg-gray-400"
        >
          Undo
        </button>
